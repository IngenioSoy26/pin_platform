...
## 7) Preparar datasets locales (NO se suben a GitHub)

Este repositorio **no incluye datasets pesados**. Los datasets deben descargarse y colocarse en carpetas locales (ignoradas por Git).
...
Fuentes/URLs oficiales: ver [FUENTES_DATASETS.md](file:///c:/Users/gusta/Desktop/Maestria/0.1.%20Practicas/pin_platform/docs/FUENTES_DATASETS.md).
